...
# This demo outputs each layer of abstraction to a file till the threshold is above `--abs_threshold`
...
while 1:
    ...
    while 1:
        is_finished=abs.do_abstract_one(abs_threshold)
        if is_finished or c==max_layers+1:
            print()
            break
        print("layer",c,"/",max_layers,end='\r')
