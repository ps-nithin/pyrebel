...
Consider two images, the <a href="sign-images/s.png">first</a> image is to be learned and the <a=href="sign-images/s-ripple.png">second</a> is to be recognized. <br>
<img src="sign-images/learn/s.png"></img>&nbsp;1.&nbsp;<img src="sign-images/recognize/s-ripple.png"></img>&nbsp;2.
<br><br>
...
Thus, the image is recognized with weightage equalling the number of signatures matched (here 8).
